...
<!-- ####################################################################################### -->
    ...
    <form class="form_details">
      <!-- Edit ward -->
      <q-dialog v-model="edit_ward_pop" persistent>
      ...
      <!-- Edit room -->
      <q-dialog v-model="edit_room_pop" persistent>
      ...
      <q-dialog v-model="delete_popup">
        <q-card class="bg-red text-white">
          <q-card-section class="text-h6 bg-red text-center" style="padding:20px;margin-bottom: 58px;">
            delete room {{activeRoom}} ?
            <q-icon name="delete_forever"/>
          </q-card-section>
          <div class="update_loc bg-red">
            <q-btn @click="deleteRoom($event)" id="Location_popUp_delete_yes" flat dense no-caps label="Yes"/>
            <q-btn type="button" @click.prevent="clicked='',delete_popup=false" id="Location_saveWard_delete_no" flat dense no-caps label="No"/>
          </div>
        </q-card>
      </q-dialog>

      <!-- Edit/ Add beds -->
      <q-dialog v-model="edit_bed_pop" persistent>
        <q-card style="background:var(--bg);grid-column: 1;font-size: large;">
      ...
      <!-- Add room -->
      <q-dialog v-model="add_room_pop" persistent>
        <q-card style="background:var(--bg);grid-column: 1;font-size: large;">
      ...
      <q-dialog v-model="saved_popup">
        <q-card class="bg-primary text-white text-right" style="height: 150px;">
          ...
          <q-card-section class="text-h5 bg-primary q-pa-md text-center">
...
export default {
  ...
  methods:{
    ...
    addWard(e){
      ...
      this.clicked = '', this.activeWard = this.activeRoom= '';
